...
export const Section07_Pricing_FAQ_Services = (): JSX.Element => {
  return (
    <section
      className="flex flex-col w-full items-start gap-6 md:gap-10 pr-6 md:pr-14 pl-14 md:pl-28 py-8 md:py-16"
      aria-label="Section 7 — Pricing, FAQ and Services"
    >
      <div className="flex flex-col lg:flex-row w-full items-start border-t-4 border-[#afafaf80] pt-px">
