...
export const PortfolioSection = (): JSX.Element => {
  return (
    <section id="platform" className="w-full flex flex-col">
      ...
      <div className="w-full h-[45vh] md:h-[50vh] lg:h-[55vh] rounded-3xl md:rounded-[40px] border-2 border-[#afafaf80] bg-gradient-to-br from-white via-gray-50/50 to-gray-100/30 backdrop-blur-md flex items-center justify-center shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] overflow-hidden relative">
