  ...
  return (
    <section className="flex flex-col items-start w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full items-stretch">
          <div className="pointer-events-none rounded-xl border border-[#afafaf80] px-5 md:px-6 pt-5 md:pt-6 pb-5 md:pb-6 bg-white shadow-lg transition-shadow duration-300 flex flex-col h-full">
