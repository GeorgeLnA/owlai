...
const getRGBA = (cssColor: string, fallback: string = "rgba(180, 180, 180)"): string => {
  ...
  const drawGrid = useCallback(
    (
      ...
      if (text) {
        ...
        maskCtx.font = `${fontWeight} ${fontSize}px "Manrope", Helvetica, sans-serif`;
